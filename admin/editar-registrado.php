  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Registrados</h1>
            <small>Llena el formulario para editar un nuevo registrado</small>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <?php 
            try {
                ...
                $sql = "SELECT * FROM registros WHERE ID_Registrado = $id";
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Editar Registrado</h3>
        </div>
        <div class="card-body">
                ...
                <form role="form" name="guardar_registro" id="guardar_registro" method="post" action="modelo-registros.php">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre del registrado" value="<?php echo $registrado['nombre_registrado']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="nombre">Apellido Registrado:</label>
                      <input type="text" class="form-control" id="apellido" name="apellido" placeholder="Apellido del registrado" value="<?php echo $registrado['apellido_registrado']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="nombre">Email del Registrado:</label>
                      <input type="text" class="form-control" id="email" name="email" placeholder="Email del registrado" value="<?php echo $registrado['email_registrado']; ?>">
                    </div>
                        ...
                        <div id="Paquetes" class="paquetes">
                            ...
                            <ul class="lista-precios">
                                ...
                                <div class="tabla-precio">
                                    ...
                                    <input value="<?php echo $boletos["un_dia"]; ?>" type="number" id="pase_dia" name="boletos[un_dia][cantidad]" min="0" size="3" placeholder="0">
                                ...
                                <div class="tabla-precio">
                                    ...
                                    <input value="<?php echo $boletos["pase_completo"]; ?>"  type="number" id="pase_completo" name="boletos[completo][cantidad]" min="0" size="3" placeholder="0">
                                ...
                                <div class="tabla-precio">
                                    ...
                                    <input value="<?php echo $boletos["pase_2dias"]; ?>" type="number" id="pase_dos_dias" name="boletos[2dias][cantidad]" min="0" size="3" placeholder="0">
                        ...
                        <div id="resumen" class="resumen">
                            ...
                            <div class="caja clearfix">
                                ...
                                <div class="orden">
                                    ...
                                    <input value="<?php echo $boletos["camisas"]; ?>" type="number" name="pedido_extra[camisas][cantidad]" size="0" id="camisas_eventos" placeholder="0">
                                ...
                                <div class="orden">
                                    <label for="etiquetas_evento">Paquete de 10 etiquetas $2 <small>(HTML5, CSS3, JavaScript,
                                        Chrome)</small></label>
                                    <input value="<?php echo $boletos["etiquetas"]; ?>" type="number" name="pedido_extra[etiquetas][cantidad]" size="0" id="etiquetas_eventos" placeholder="0">
                                ...
                                <div class="orden">
                                    ...
                                    <?php 
                                      if($registrado["regalos"] == 2) {
                                    ?>
                                      <option value="2" selected>Etiquetas</option>
                                      <option value="1">Pulsera</option>
                                      <option value="3">Plumas</option>
                                    <?php 
                                      } else if($registrado["regalos"] == 1) {
                                    ?>
                                      <option value="2" >Etiquetas</option>
                                      <option value="1" selected>Pulsera</option>
                                      <option value="3">Plumas</option>
                                    <?php 
                                      } else if($registrado["regalos"] == 3) {
                                    ?>
                                      <option value="2">Etiquetas</option>
                                      <option value="1">Pulsera</option>
                                      <option value="3" selected>Plumas</option>
                                    <?php 
                                      }
                                    ?>
